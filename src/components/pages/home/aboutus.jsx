...
<main>
<section className="pt-3" id="carousel-hold">
            <div className="d-flex justify-content-around align-items-center mb-3 py-4">
                <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div id="carousel-1" class="carousel slide border" data-ride="carousel" data-pause="false">
                            ...
                            <div className="carousel-item">
                                ...
                                <div className="card" style={{borderRadius: "20px"}}>
                                    <div className="card-img" style={{width: "80%" ,margin: "0 auto"}}>
                                        <img src="https://oeson.b-cdn.net/New%20folder/Rectangle%2093.png" alt="mobile development" width="100%"/>
                                    </div>
                                    <div className="card-body text-center">
                ...
                <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div id="carousel-2" className="carousel slide" data-ride="carousel" data-pause="false" style={{position : "relative"}}>
                ...
                <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div id="carousel-3" className="carousel slide" data-ride="carousel" data-pause="false">
                        <div className="carousel-inner">
                            <div className="carousel-item">
                            ...
                            <div className="carousel-item">
                                ...
                                <div className="card" style={{bordeRadius: "20px"}}>
                                    <div className="card-img" style={{width: "80%", margin:" 0 auto;"}}>
                                        <img src="https://oeson.b-cdn.net/New%20folder/Rectangle%2093.png" alt="mobile development" style = {{width:"100%"}}/>
                                    </div>
                                    <div className="card-body text-center">
