            ...
            <section id="career-sec">
                    ...
                    <div>
                        ...
                        <div className="d-flex flex-wrap justify-content-center">
                            ...
                            <div className="col-12 col-md-8 col-lg-6 my-2">
                                <a href="./internship.html" className="card-body d-flex" style={{ background: "#00B28F", border: "none" }}>
                                    <div className="col-6 text-white">
                                        <br />
                                        <h5>Student / Internships</h5>
                                    </div>
                                    <div className="col-6">
                                        <img src="https://oeson.b-cdn.net/New%20folder/Rectangle%20165.png" alt="Student" width="100%" />
                                    </div>
                                </a>
                            </div>
                            <div className="col-12 col-md-8 col-lg-6 my-2">
                                <a href="./jobs.html" className="card-body d-flex h-100" style={{ background: "#F16C51" }}>
                                    <div className="col-5 text-white">
                                        <br />
                                        <h5>Explore Opportunities <br /> by Location</h5>
                                    </div>
                                    <div className="col-7">
                                        <img src="https://oeson.b-cdn.net/New%20folder/Rectangle%20164.png" alt="Student" width="100%" />
                                    </div>
                                </a>
                            </div>
                        </div>
                ...
                <div className="no-small">
                    <div className="d-flex container">
                        <div className="col-3">
                            <img src="https://oeson.b-cdn.net/New%20folder/unsplash_-VHQ0cw2euA.png" alt="macbook" width="100%" />
                        </div>
                        <div className="col-9">
                            <div className="d-flex w-100">
                                <div className="col-7">
                                    <img src="https://oeson.b-cdn.net/New%20folder/1212.png" alt="desk" width="100%" />
                                </div>
                                <div className="col-5">
                                    <img src="https://oeson.b-cdn.net/New%20folder/unsplash_wD1LRb9OeEo.png" alt="discussion" width="100%" />
                                </div>
                            </div>
                        </div>
                    </div>
